...
async fn main() -> std::result::Result<(), Box<dyn std::error::Error>> {
  ...
  info!("GURT server starting on gurt://0.0.0.0:4878");
...
async fn handle_redirect(
  ...
  let api_url = format!("http://linc.thond.re/api/redirect/{}", short_url);
    ...
    Ok(response) => {
      if response.status().is_success() {
        match response.json::<Value>().await {
          Ok(json_data) => {
            if
              let Some(original_url) = json_data
                .get("url")
                .and_then(|u| u.as_str())
            {
              ...
              let redirect_html = format!(
                r#"
                  ...
                  <html>
                  <head>
                    <title>Redirecting... - Linc</title>
                    <meta http-equiv="refresh" content="0;url={}">
                    <icon src="https://thond.re/logo.png">
                    <meta name="description" content="Linc is a simple URL shortener built for Gurted.">
                    <font name="onest" src="https://fonts.gstatic.com/s/onest/v8/gNMKW3F-SZuj7xmf-HY.woff2" />
                  </head>
                  <body>
                    <h1>Redirecting...</h1>
        ...
        let not_found_html =
          format!(r#"
            ...
            <html>
            <head>
              <title>URL Not Found - Linc</title>
              <icon src="https://thond.re/logo.png">
              <meta name="description" content="Linc is a simple URL shortener built for Gurted.">
              <font name="onest" src="https://fonts.gstatic.com/s/onest/v8/gNMKW3F-SZuj7xmf-HY.woff2" />
            </head>
            <body>
              ...
              <p><a href="gurt://li.nc/">Create a new short URL</a></p>
            </body>
            </html>
          "#, short_url);
        Ok(
